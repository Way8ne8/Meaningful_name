...
class ProductPage(BasePage):
    ...
    def check_messages(self):
        ...
        assert self.browser.find_element(*ProductPageLocators.NAME_IN_BASKET).text == self.browser.find_element(*ProductPageLocators.NAME_PRODUCT).text, \
            "Название на странице и в корзине не совпадают"
        assert self.browser.find_element(*ProductPageLocators.VALUE_IN_MESSEGE).text == self.browser.find_element(*ProductPageLocators.VALUE_ON_PAGE).text, \
